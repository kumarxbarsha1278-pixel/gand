...
TELEGRAM_CHANNEL = "https://t.me/+B0vnERtU_lczYmY"
...
def handle_expired_script(message):
    bot.reply_to(
        message, 
        "⚠️ <b>SCRIPT EXPIRE OWNER TO BUY PREMIUM SCRIPT @Swarg_developer</b>", 
        parse_mode="HTML")
